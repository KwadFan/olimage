...
bash run_headless.sh -v image --size 500 --ssh --hostname ultimainsailos A20-OLinuXino-lime2 bullseye base ultimainsailos-bullseye-A20-l2-$(date +%Y%m%d-%H%M%S).img
